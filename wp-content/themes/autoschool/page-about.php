...
<section>
    <div class="container">
        <div class="row">
			...
			<?php $files = get_field( 'fajly' ); //dump($files); ?>
            <div class="col-md-12">
				<?php foreach ( $files as $file ) {
				if ( isset( $file['url'] ) ) {
				?>
                <div class="doc-list-inner__icon-wrapper mb-3 shadow p-3">
                    <a href="<?php echo $file['url'] ?>" target="_blank" class="d-flex align-items-center font-weight-bold">
                        <i class="file-type__icon file-type__icon--pdf"></i> <span
                                class="ml-4"><?php echo $file['title'] ?></span>
                    </a>
                </div>
				<?php }
