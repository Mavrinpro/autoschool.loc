...
<div id="page" class="site">
    ...
    <!--                               data-btn="Заказать звонок" rel="nofollow"><i class="fa fa-map-marker"></i> -->
	<?php //echo get_field('settings', 72)['adress'] ?><!--</a></li>-->
    <!--                    </ul>-->
    <!---->
    <!--                </div>-->
    <!--            </div>-->
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-4 mb-4 mb-md-0">
                        <div id="logo "><a href="/"
                                           title="Центр страхования"><?php the_custom_logo( [ [ 'class' => 'egerge' ] ] ) ?></a>
                        </div>
                                            ...
                                            <div class="cell-text">
                                                ...
                                                <div class="text_body">
                                                    <div class="align-elem">
                                                        <div>
                                                            <a href="tel:<?php echo get_field( 'settings', 72 )['phone'] ?>"><?php echo get_field( 'settings', 72 )['phone'] ?></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="more text-center">
                            <a data-toggle="modal" data-target="#orangeModalSubscription" href="##"><span
                                        class="align-elem">Перезвоните мне</span></a>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <nav class="navbar navbar-expand-lg navbar-dark">
                    ...
                    <!-- Collapse button -->
                    <div class="hamburger hamburger--spin-r navbar-toggler border-0 collapsed" data-toggle="collapse"
                         data-target="#basicExampleNav" aria-controls="navbarNavAltMarkup" aria-expanded="false"
            ...
            <div class="row">
                <div class="col-12 mt-3">
					<?php if ( function_exists( 'yoast_breadcrumb' ) ) {
						yoast_breadcrumb( '<p class="p-0" id="breadcrumbs">', '</p>' );
					} ?>
                </div>
            </div>
        </div>
